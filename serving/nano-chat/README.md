...
Preview remains in the browser. Explicit analysis sends a JPEG snapshot (maximum 640 pixels wide) to the server and hosted model API. The application does not save frames. Modes: Scene scientist, Read and explain, Invent with objects, Robot planner. Robot planner only describes hypothetical steps; it cannot control hardware.
