# Manual and historical reference

Use the [current README](../README.md) for the three-demo setup. These earlier manual workflows include additional downloads and optional audio/training; they are not required by the default menu. Run shell commands from the repository root.
...
After core setup, follow [docs/VISION.md](VISION.md):
