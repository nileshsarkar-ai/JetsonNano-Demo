...
2026-09-24 visual revision: text conversation slide uses live prompt examples; camera slide includes an AI-generated illustrative tabletop scene with cup, bottle and book, labelled as illustrative. It is not measured camera output. `tabletop-scene.png` is the editable source asset. Keep the three-demo scope and avoid fabricated screenshots/results.
